...
<jsp:useBean id="videoOne" scope="request" type="javaBean.VideoBean"/>
...
<form action="${pageContext.request.contextPath}/HandleUpdate?type=video" method="post">
    <label>视频编号<input type="text" name="vid" readonly value="${videoOne.vid}"/></label><br/>
    ...
    <label>封面<input type="text" name="img"      readonly    value="${videoOne.img}"/></label><br/>
    <label>视频<input type="text" name="path" readonly value="${videoOne.path}"/></label><br/>
