...
<form action="${pageContext.request.contextPath}/HandleAdd?type=teacher" method="post">
    <label>账号<input type="text" required name="username"/></label><br/>
    <label>密码<input type="text" required name="password"/></label><br/>
    <label>证明<input type="text" required name="prone"/></label><br/>
    <label>介绍<input type="text" required name="introduce"/></label><br/>
