...
public interface VideoDao {
    ...
    public int deleteByTid(int Tid) throws Exception;//级联删除

    VideoBean getOneByVid(int Vid) throws Exception;
    public List<VideoBean> getOneByTid(int Vid) throws Exception;
    ...
    public List<VideoBean> getByCategory(String instrumentType,String hardType) throws Exception;//获取对象组
